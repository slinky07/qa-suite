...
| Platform                   | Install                                                                                                                                                                                                                                  |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Claude Code                | Add this repo as a plugin marketplace with `/plugin marketplace add slinky07/qa-suite`, then install `qa-suite` with `/plugin install qa-suite@qa-suite`. For simple local use, you can still copy `qa-suite/` into `~/.claude/skills/`. |
| Claude.ai                  | Download `qa-suite.skill` from this repo’s Releases page and upload it as a skill.                                                                                                                                                       |
| Codex CLI                  | Add this repo as a plugin marketplace with `codex plugin marketplace add slinky07/qa-suite`, then install the plugin with `codex plugin add qa-suite --marketplace qa-suite`.                                                            |
| Codex Desktop              | Add `slinky07/qa-suite` as a marketplace in the Plugins area, then install the `qa-suite` plugin from that marketplace.                                                                                                                  |
