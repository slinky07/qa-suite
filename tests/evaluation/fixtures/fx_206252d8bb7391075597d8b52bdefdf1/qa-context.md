...
- **Repository docs to read first:** tests/evaluation/fixtures/fx_206252d8bb7391075597d8b52bdefdf1/public/deployment.md
- **Report output folder:** QA/
- **Intended audience:** Operators viewing public service status.

## Finding ledger

- **Path:** tests/evaluation/fixtures/fx_206252d8bb7391075597d8b52bdefdf1/public/findings.jsonl
...
- **Design docs:** tests/evaluation/fixtures/fx_206252d8bb7391075597d8b52bdefdf1/public/deployment.md
...
- **How to start the app (dev path):** `node tests/evaluation/fixtures/fx_206252d8bb7391075597d8b52bdefdf1/public/server.mjs 4173`
...
- **Fast validation:** `node --check tests/evaluation/fixtures/fx_206252d8bb7391075597d8b52bdefdf1/public/server.mjs`
...
- **Contract source:** tests/evaluation/fixtures/fx_206252d8bb7391075597d8b52bdefdf1/public/deployment.md
